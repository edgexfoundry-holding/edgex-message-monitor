...
func dummyEvent() appTypes.MessageEvent {
...
func interestingEvent() appTypes.MessageEvent {
	return appTypes.MessageEvent{
		Topic: "Test_Topic",
		Event: dtos.Event{Versionable: common.Versionable{},
			Id:          "interesting_id",
