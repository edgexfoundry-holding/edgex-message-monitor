...
func (c *Config) GetSelectedMessaging() MessagingType {
	return MessagingType(c.app.Preferences().StringWithFallback(PrefSelectedMessaging, string(DefaultSelectedMessaging)))
}
...
func (c *Config) GetRedisPassword() string {
	return c.app.Preferences().StringWithFallback(PrefRedisPassword, "")
}
...
func (c *Config) GetMQTTClientId() string {
	return c.app.Preferences().StringWithFallback(PrefMQTTClientId, "")
}
func (c *Config) GetMQTTUsername() string {
	return c.app.Preferences().StringWithFallback(PrefMQTTUsername, "")
}
func (c *Config) GetMQTTPassword() string {
	return c.app.Preferences().StringWithFallback(PrefMQTTPassword, "")
}
