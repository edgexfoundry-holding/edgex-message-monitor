...
func TestClient_Subscribe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockPreferences.On("StringWithFallback", "_PrefProcotol", "Redis").Return("Redis")
			mockPreferences.On("StringWithFallback", "_RedisPassword", "").Return("")
			...
			events := make(chan *appTypes.MessageEvent)
